...
\title{Trust not, verify. \\ How to verify \\ algorithms \\ with model checker}
\date{\today}
...
% --------------------------------------------------------------------------- %
  \begin{frame}{About Me}
    \begin{itemize}
        \item \textbf{[Software Engineer]}  DataRobot (model management and monitoring team)
        \item \textbf{[Github]}
            \href{https://github.com/jettify}{http://github.com/jettify}
        \item \textbf{[Twitter]}
...
% --------------------------------------------------------------------------- %
  ...
  \begin{frame}{The Fix}
    Quick Fix
    \begin{center}
      \inputminted[firstline=9,lastline=11,linenos, fontsize=\small]{python}{figures/queue_fixed.py}
    \end{center}
    Proper Fix (CPython implementation)
    \begin{center}
      \inputminted[firstline=15,lastline=19,linenos, fontsize=\small]{python}{figures/queue_fixed.py}
    \end{center}
  \end{frame}
